...
SECRET_KEY = 'django-insecure-wr7wqb^qjab1i(jidom#vy4z4^inu&e(^*ob1mc)p0o3fp0!5z'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'eventmaster_db'),
        'USER': os.environ.get('DATABASE_USER', 'gana_admin'),
